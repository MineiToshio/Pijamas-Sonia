...
(function ($) {
  ...
  var variantPicker = function () {
    if ($(".variant-picker-item").length) {
      $(".variant-picker-item label").on("click", function (e) {
        $(this).closest(".variant-picker-item").find(".variant-picker-label-value").text($(this).data("value"));
      });
    }
    if ($(".variant-picker-item").length) {
  ...
  var clickModalSecond = function () {
    ...
    $(".tf-mini-cart-tool-close ,.tf-mini-cart-tool-close .overplay").click(function () {
  ...
  var totalPriceVariant = function () {
    var basePrice =
      parseFloat($(".price-on-sale").data("base-price")) || parseFloat($(".price-on-sale").text().replace("S/. ", ""));
    ...
    $(".color-btn, .size-btn").on("click", function () {
      ...
      quantityInput.val(1);
      $(".price-on-sale").text("S/. " + newPrice.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));
      var totalPrice = newPrice;
      $(".total-price").text("S/. " + totalPrice.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));
    });
  ...
  var totalVariant = function () {
    $(".tf-variant-item,.tf-cart-item").each(function () {
      ...
      var basePrice =
        parseFloat(productItem.find(".tf-variant-item-price .price").data("base-price")) ||
        parseFloat(productItem.find(".tf-variant-item-price .price").text().replace("$", ""));
      ...
      productItem.find(".color-btn, .size-btn").on("click", function () {
        ...
        productItem
          ...
          .text("$" + newPrice.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));
      ...
      function updateTotalPrice(price, scope) {
        ...
        scope
          ...
          .text("$" + totalPrice.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));
      }
    });
  };
