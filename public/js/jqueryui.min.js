...
(function (factory) {
  ...
  var effectsEffectScale = $.effects.define("scale", function (options, done) {
    ...
    var el = $(this),
      mode = options.mode,
      percent =
        parseInt(options.percent, 10) || (parseInt(options.percent, 10) === 0 ? 0 : mode !== "effect" ? 0 : 100),
      newOptions = $.extend(
        true,
        {
...
*/
  ...
  var widgetsProgressbar = $.widget("ui.progressbar", {
    ...
    _refreshValue: function () {
      ...
      this._toggleClass(this.valueDiv, "ui-progressbar-complete", null, value === this.options.max)._toggleClass(
        ...
        $.each(items, function (index, item) {
          ...
          if (item.optgroup !== currentOptgroup) {
            ...
            that._addClass(
              ...
              "ui-menu-divider" + (item.element.parent("optgroup").prop("disabled") ? " ui-state-disabled" : ""),
            );
