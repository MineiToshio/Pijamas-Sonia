    ...
    var t = {
        ...
        8457: function (t, n, e) {
          ...
          t.exports = function (t) {
            ...
            if (!O || (this === p && a(O)))
              ...
              for (w = (x = l(n, O)).next, m = e ? new this() : []; !(b = o(w, x)).done; E++)
        ...
        1589: function (t, n, e) {
          ...
          t.exports = function (t, n, e) {
            for (var s = o(t), u = r(n, s), f = r(void 0 === e ? s : e, s), l = c(a(f - u, 0)), d = 0; u < f; u++, d++)
              i(l, d, t[u]);
            return (l.length = d), l;
          };
        },
        ...
        7475: function (t, n, e) {
          ...
          t.exports = function (t) {
            ...
            return (
              r(t) &&
                ((n = t.constructor),
                ((o(n) && (n === a || r(n.prototype))) || (i(n) && null === (n = n[c]))) && (n = void 0)),
              void 0 === n ? a : n
            );
          };
        },
          ...
          t.exports = function (t, n, e, c, v, g, A) {
            ...
            if (
              (R &&
                ...
                j.next &&
                (i || u(j) === b || (f ? f(j, b) : a(j[w]) || p(j, w, _)), l(j, P, !0, !0), i && (h[P] = _)),
              y &&
                v == O &&
                k &&
                k.name !== O &&
              ...
              if (((C = { values: T(O), keys: g ? F : T(S), entries: T(E) }), A))
            ...
            c(function () {
              ...
              ? function (t, n) {
                  for (var e = f(t), o = arguments.length, c = 1, d = s.f, p = u.f; o > c; )
                    for (var h, g = l(arguments[c++]), y = d ? v(a(g), d(g)) : a(g), m = y.length, b = 0; m > b; )
          ...
          (a[f] = !0),
            (t.exports =
              ...
              function (t, n) {
                var e;
                return (
                  null !== t ? ((l.prototype = o(t)), (e = new l()), (l.prototype = null), (e[f] = t)) : (e = v()),
                  void 0 === n ? e : i.f(e, n)
                );
              });
        },
            ...
            ? i
              ? function (t, n, e) {
                  if (
                    ...
                    (n = a(n)),
                    c(e),
                    "function" == typeof t && "prototype" === n && "value" in e && "writable" in e && !e.writable)
                  ) {
                    var r = f(t, n);
                    r &&
                      r.writable &&
            ...
            ("__proto__" in {}
              ? (function () {
                  var t,
                    ...
                    e = {};
                  try {
                    (t = r(Object.getOwnPropertyDescriptor(Object.prototype, "__proto__").set))(e, []),
            ...
            { target: "Array", proto: !0, forced: !v },
            {
              slice: function (t, n) {
                ...
                if (
                  o(d) &&
                  ((e = d.constructor),
                  ((i(e) && (e === g || o(e.prototype))) || (c(e) && null === (e = e[h]))) && (e = void 0),
                  e === g || void 0 === e)
                )
                  return p(d, m, b);
          ...
          var r = e(2109),
            ...
            it = function (t, n, e) {
              ...
              return (
                ...
                l(Z, r)
                  ? (e.enumerable
                      ? (l(t, N) && t[N][r] && (t[N][r] = !1), (e = m(e, { enumerable: y(0, !1) })))
            ...
            at = function (t) {
              ...
              return (
                !(this === Y && l(Z, n) && !l(tt, n)) &&
                (!(e || !l(this, n) || !l(Z, n) || (l(this, N) && this[N][n])) || e)
              );
            },
            st = function (t, n) {
              var e = v(t),
            ...
            n
              ? ((i = i.filter(function (t) {
                ...
                o &&
                  ...
                  c &&
                    0 === i.length &&
                    (document.removeEventListener("touchmove", d, t ? { passive: !1 } : void 0), (c = !1))),
                o
                  ? (function () {
                      if (void 0 !== u) {
                        ...
                        t.arrowAnimator.forEach(function (e, r) {
                          e.style.cssText = "\n        ".concat(
                            t.settings.verticalMode
                              ? "transform: translateY(".concat(n[1] * (0 === r ? 1 : -1), "px);")
                              : "transform: translateX(".concat(n[1] * (0 === r ? 1 : -1), "px);"),
                            "\n        ",
                          );
                        });
                      }),
                          ...
                          e.style.cssText = "\n        ".concat(
                            t.settings.verticalMode
                              ? "transform: translateY(".concat(
                                  0 === r ? "".concat(n[0], "px") : "-".concat(n[0], "px"),
                                  ");",
                                )
                    ...
                    this.arrowAnimator.forEach(function (n, e) {
                      n.classList.add("icv__arrow-wrapper"),
                        (n.style.cssText = "\n      ".concat(
                          t.settings.verticalMode
                            ? "transform: translateY(".concat(
                                0 === e ? "".concat(s[0], "px") : "-".concat(s[0], "px"),
                                ");",
                              )
                            : "transform: translateX(".concat(
                                0 === e ? "".concat(s[0], "px") : "-".concat(s[0], "px"),
                        ...
                        .concat(
                          "ontouchstart" in document.documentElement
                            ...
                            : this.settings.smoothing
                              ? "transition: ".concat(this.settings.smoothingAmount, "ms ease-out;")
                              : "",
                          "\n    ",
                        )),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    for (var o = 0; o <= 1; o++) {
                      var i = r[o];
                      if (
                        (i.classList.add("icv__img"), i.classList.add(0 === o ? "icv__img-a" : "icv__img-b"), 1 === o)
                      ) {
                        var c = document.createElement("div"),
                          a = r[1].src;
                            ...
                            .concat(
                              this.settings.fluidMode &&
                                "background-image: url("
                                  ...
                                  .concat(
                                    this.settings.verticalMode
                                      ? " 0 0 ".concat(100 - this.settings.startingPoint, "% 0")
                                      : "0 0 0 ".concat(this.settings.startingPoint, "%"),
                                    ")",
                                  ),
                              "\n        ",
                            )),
