...
(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function (n, e, t, u, a) {
      ...
      return 1 > e
        ? -0.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin(((e * a - r) * (2 * Math.PI)) / i)) + t
        : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(((e * a - r) * (2 * Math.PI)) / i) * 0.5 + u + t;
    },
                ...
                (this.settings.orientation.includes("left") || this.settings.orientation.includes("right")) &&
                  ...
                  (t =
                    !1 === this.settings.overflow
                      ? "translate3d(".concat(n, ", ").concat(e, ", 0) scale(").concat(this.settings.scale, ")")
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (m = y.length) ||
                    (window.cancelAnimationFrame(p), window.removeEventListener("resize", this.handleResize));
                },
              },
            ]) && f(e.prototype, n),
            i && f(e, i),
...
!(function (n, t) {
  ...
  function p(n, t, e, r) {
    ...
    return (
      t && (i.className = t), e && (!r && i.setAttribute("data-" + t, e), (i.textContent = e)), (n && f(n, i)) || i
    );
  }
  function h(n, t) {
        ...
        return this.runValidators(r).done(function (e) {
          r.data("bs.validator.errors", e),
            ...
            (i && e.toString() === i.toString()) ||
              ((o = e.length
                ? t.Event("invalid.bs.validator", { relatedTarget: r[0], detail: e })
                : t.Event("valid.bs.validator", { relatedTarget: r[0], detail: i })),
              s.$element.trigger(o)),
            s.toggleSubmit(),
