!(function (e, t) {
  ...
  !(function (T) {
    ...
    function P(e, t, i) {
      ...
      for (var s = Object.keys(t), n = 0, o = e.length; n < o; n++)
        for (var l = e[n].querySelectorAll("*"), r = 0, a = l.length; r < a; r++) {
          ...
          if (-1 !== s.indexOf(d))
            for (
              var h = [].slice.call(c.attributes), p = [].concat(t["*"] || [], t[d] || []), u = 0, f = h.length;
              u < f;
              u++
            ) {
              var m = h[u];
      ...
      (te.prototype = {
        ...
        createView: function (z, e, t) {
          ...
          function W(e, t) {
            ...
            for (var f = 0; f < s; f++) {
              ...
              void 0 === l &&
                e - 1 <= N.selectpicker.current.data[m - 1].position - N.sizeInfo.menuInnerHeight &&
                (l = f);
            }
            if (
              (void 0 === l && (l = 0),
        ...
        buildList: function (e, t) {
          ...
          (!n.options.showTick && !n.multiple) ||
            ...
            ((K.checkMark.className = this.options.iconBase + " " + n.options.tickIcon + " check-mark"),
        ...
        selectPosition: function () {
          ...
          function e(e) {
            var t = {},
              i =
                l.options.display || (!!T.fn.dropdown.Constructor.Default && T.fn.dropdown.Constructor.Default.display);
            l.$bsContainer
        ...
        setSelected: function (e, t) {
          ...
          o &&
            ...
            r
              ? (this.focusItem(o, e), (this.selectpicker.view.currentActive = o), (this.activeIndex = n))
              : this.defocusItem(o),
            s &&
        ...
        clickListener: function () {
          ...
          t.data("spaceSelect", !1),
            ...
            this.$newElement.on("show.bs.dropdown", function () {
              O.dropdown ||
                "4" !== j.major ||
                ((O.dropdown = O.$button.data("bs.dropdown")), (O.dropdown._menu = O.$menu[0]));
            }),
                    ...
                    if ((g && w) || (b && I))
                      if (g && 1 == g) (s.selectedIndex = -1), (p.selected = !0), O.setOptionStatus(!0);
                        ...
                        $[2] &&
                          ...
                          g &&
                            w &&
                            (C.append(T("<div>" + S + "</div>")), (h = !1), O.$element.trigger("maxReached" + F)),
                          b &&
                            I &&
    ...
    function ne() {
      return j.major < 5
        ? T.fn.dropdown
          ? (T.fn.dropdown.Constructor._dataApiKeydownHandler || T.fn.dropdown.Constructor.prototype.keydown).apply(
              this,
              arguments,
            )
          : void 0
