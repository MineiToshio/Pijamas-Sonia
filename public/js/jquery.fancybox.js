...
(function (window, document, $, undefined) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    jumpTo: function (pos, duration, slide) {
      ...
      current.isMoved =
        (currentPos.left !== 0 || currentPos.top !== 0) && !current.$slide.hasClass("fancybox-animated");
...
(function ($) {
  ...
  var defaults = {
    ...
    gmap_search: {
      ...
      url: function (rez) {
        return (
          "//maps.google." + rez[2] + "/maps?q=" + rez[5].replace("query=", "q=").replace("api=1", "") + "&output=embed"
        );
      },
    },
  };
    ...
    if (type) {
      ...
      if (type === "iframe") {
        ...
        item.opts.slideClass +=
          " fancybox-slide--" + (provider == "gmap_place" || provider == "gmap_search" ? "map" : "video");
      }
    } else if (url) {
...
(function (window, document, $) {
  ...
  Guestures.prototype.ontouchstart = function (e) {
    ...
    if (self.startPoints.length === 1) {
      if (
        current.type === "image" &&
        (self.contentStartPos.width > self.canvasWidth + 1 || self.contentStartPos.height > self.canvasHeight + 1)
      ) {
...
(function (document, $) {
  ...
  $.extend(FancyThumbs.prototype, {
    ...
    create: function () {
      ...
      self.$grid = $('<div class="fancybox-thumbs fancybox-thumbs-' + self.opts.axis + '"></div>').appendTo(
