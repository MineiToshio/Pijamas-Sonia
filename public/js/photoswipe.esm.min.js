...
class S {
  ...
  S(t) {
    ...
    return (
      (t -
        (null !== (i = null === (s = this.pswp.currSlide) || void 0 === s ? void 0 : s.bounds.center.y) && void 0 !== i
          ? i
          : 0)) /
...
class tt {
  ...
  Vt() {
    ...
    if (((this.Zt = !this.kt && this.pswp.options.bgOpacity > 0.003), (this.Ft = this.kt ? t.element : t.bg), !this.Et))
      return (
        (this.It = 0),
        (this.$t = !1),
        (this.Zt = !1),
        (this.kt = !0),
        void (this.isOpening && (t.element && (t.element.style.opacity = String(0.003)), t.applyBgOpacity(1)))
      );
    ...
    this.isOpening
      ? (this.kt
          ? (t.element && (t.element.style.opacity = String(0.003)), t.applyBgOpacity(1))
          : (this.Zt && t.bg && (t.bg.style.opacity = String(0.003)), t.element && (t.element.style.opacity = "1")),
        this.$t &&
          (this.qt(), this.Bt && ((this.Bt.style.willChange = "transform"), (this.Bt.style.opacity = String(0.003)))))
      : this.isClosing &&
