!(function (t) {
  ...
  function o(t, e, r) {
    ...
    if (("number" == typeof e && (e = [e]), !Array.isArray(e)))
      throw new Error("noUiSlider (" + et + "): 'range' contains invalid value.");
  ...
  (l.prototype.getMargin = function (t) {
    ...
    if (e && (t / e) % 1 != 0)
      throw new Error("noUiSlider (" + et + "): 'limit', 'margin' and 'padding' must be divisible by step.");
  ...
  function m(t, e) {
    ...
    if (void 0 === e.min || void 0 === e.max)
      throw new Error("noUiSlider (" + et + "): Missing 'min' or 'max' in 'range'.");
  ...
  function b(t, e) {
    if ("boolean" != typeof (t.animate = e))
      throw new Error("noUiSlider (" + et + "): 'animate' option must be a boolean.");
  }
  function S(t, e) {
    if ("number" != typeof (t.animationDuration = e))
      throw new Error("noUiSlider (" + et + "): 'animationDuration' option must be a number.");
  }
  function w(t, e) {
    var r,
      n = [!1];
  ...
  function E(t, e) {
    ...
    if (((t.limit = t.spectrum.getMargin(e)), !t.limit || t.handles < 2))
      throw new Error(
        "noUiSlider (" + et + "): 'limit' option is only supported on linear sliders with 2 or more handles.",
      );
  }
  function C(t, e) {
    ...
    if (0 !== e) {
      ...
      if (t.padding[0] < 0 || t.padding[1] < 0)
        throw new Error("noUiSlider (" + et + "): 'padding' option must be a positive number(s).");
      if (100 <= t.padding[0] + t.padding[1])
        throw new Error("noUiSlider (" + et + "): 'padding' option must not exceed 100% of the range.");
    }
  }
  function N(t, e) {
    switch (e) {
  ...
  function U(t, e) {
    if ("string" != typeof e)
      throw new Error("noUiSlider (" + et + "): 'behaviour' must be a string containing options.");
    ...
    if (s && (t.margin || t.limit))
      throw new Error("noUiSlider (" + et + "): 'unconstrained' behaviour cannot be used with margin or limit");
    t.events = {
      tap: r || o,
      drag: n,
      fixed: i,
  ...
  function M(t, e) {
    if ("boolean" != typeof (t.keyboardSupport = e))
      throw new Error("noUiSlider (" + et + "): 'keyboardSupport' option must be a boolean.");
  }
  function V(t, e) {
    t.documentElement = e;
  }
  function O(t, e) {
    if ("string" != typeof e && !1 !== e)
      throw new Error("noUiSlider (" + et + "): 'cssPrefix' must be a string or `false`.");
    t.cssPrefix = e;
  }
  function L(t, e) {
  ...
  function z(t, f, o) {
    ...
    function R(t, e) {
      e.handle && (st(e.handle, f.cssClasses.active), (v -= 1)),
        ...
        0 === v &&
          ...
          J(),
          t.cursor && ((C.style.cursor = ""), C.removeEventListener("selectstart", rt))),
    ...
    function I(t, e, r, n, i, o) {
      return (
        ...
        f.padding &&
          (0 === e && (r = Math.max(r, f.padding[0])), e === u.length - 1 && (r = Math.min(r, 100 - f.padding[1]))),
      ...
      (a = {
        ...
        steps: function () {
          return m.map(function (t, e) {
            ...
            !1 !== i && n + i > r.stepAfter.startValue && (i = r.stepAfter.startValue - n),
              (o =
                n > r.thisStep.startValue ? r.thisStep.step : !1 !== r.stepBefore.step && n - r.stepBefore.highestStep),
        ...
        setHandle: function (t, e, r) {
          ...
          if (!(0 <= (t = Number(t)) && t < g.length))
            throw new Error("noUiSlider (" + et + "): invalid handle number, got: " + t);
